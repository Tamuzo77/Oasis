                        ...
                        <div class="dropdown dropstart">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuOne">
                                <a class="dropdown-item d-flex align-items-center" onclick="hide()" href="#!"><i
                                        class="me-2
                        dropdown-item-icon "
                                        data-feather="eye-off"></i>Hide</a>
                                <a class="dropdown-item d-flex align-items-center" onclick="edit()" href="#"><i
                                        class="me-2
                        dropdown-item-icon "
                                        data-feather="edit-2"></i>Edit
                                </a>
                                <a class="dropdown-item d-flex align-items-center" onclick="copyPartLink()"
                                    href="#!"><i class="me-2
                        dropdown-item-icon "
                                        data-feather="link"></i>Get Link</a>
