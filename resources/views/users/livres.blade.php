    ...
    <main class="my-4 text-lg-start">
        ...
        <div class="row justify-content-center mx-sm-0 mx-1 px-0 livres">
            ...
            <a href="" class="row col-md-3 col-lg-2 col-sm-5 col-7 align-items-center shadow mx-2 px-0 mt-4 pb-2">
                <img class=" m-auto rounded-sm p-0 mt-0" src="oasis/accueil/WhatsApp Image 2023-01-05 at 13.54.13 (1).jpeg" alt="">
                <div class="mt-1 mx-1">
                    <h4>title</h4>
                    <p>Lorem ipsum dolor dignissimos similiq illo ipsum excepturi quos....</p>
                    <span>20$</span>
                </div>
            </a>
            <a href="" class="row col-md-3 col-lg-2 col-sm-5 col-7 align-items-center shadow mx-2 px-0 mt-4 pb-2">
