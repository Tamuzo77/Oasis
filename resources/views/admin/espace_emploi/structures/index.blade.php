<x-admin.layout title="Recruteurs ou Structures">
    <x-admin.header title="Recruteurs ou Structures "
    subtitle="Liste des différents recruteurs enrgistrer dans la plateforme"
     />
                                 ...
                                 <tbody>
                                     @forelse ($structures as $structure)
                                         <tr>
                                             ...
                                             <td class="ps-0">
                                                 <div class="d-flex align-items-center">
                                                     ...
                                                     <div class="ms-3">
                                                         <h5 class="mb-0">
                                                             <a href="#!"
                                                                 class="text-inherit">{{ $structure->name }}</a>
                                                         </h5>
                                                         <p class="mb-0 text-muted"> Téléphone :
                                                             {{ $structure->tel }}</p>
                                                     </div>
                                                 </div>
                                             </td>
                                             ...
                                             <td>{{ $structure->ifu }}</td>
                                             <td>
                                                 {{$structure->lien_facebook ?? 'N/A'}}
                                             </td>
                                             <td>
                                                {{$structure->lien_github ?? 'N/A'}}
                                            </td>
                                            <td>
                                                {{$structure->lien_linkedin ?? 'N/A'}}
                                            </td>
                                             <td class="text-end">
                                                         ...
                                                         <form
                                                             ...
                                                             <button type="submit"
                                                                 ...
                                                                 <i class=" dropdown-item-icon"
                                                                     data-feather="edit"></i>Voir les Offres
                                                             </button>
                                                         </form>
                                                         <div class="dropdown-divider"></div>
                                                         <form
                                                             action="{{ route('admin.recruteurs.destroy', \Crypt::encrypt($structure->id)) }}"
                                                             method="post">
                                                             @csrf
                                                             @method('DELETE')
                                                             <button type="submit"
