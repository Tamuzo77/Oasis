<x-admin.layout title="Catégories d'Actualité">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Types de Produits</li>
        </ol>
    </nav>
                    ...
                    <td class="text-end">
                        <div class="dropdown dropstart">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                <form action="{{route('admin.categoryNew-delete', \Illuminate\Support\Facades\Crypt::encrypt($type->id)) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                ...
                <tr>
                    <td colspan="7">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h4 class="mb-0 fs-5"><a href="#!" class="text-inherit">Ajouter</a></h4>
                            </div>
                        </div>
                    </td>
