                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="p-6 d-lg-flex justify-content-between align-items-center ">
                                <div class="d-md-flex align-items-center">
                                    <img src="admin/assets/images/avatar/avatar-3.jpg" alt="Image"
                                ...
                                <div class="mt-6 mb-3">
                                    <div class="progress" style="height: 40px;">
                                        <div class="progress-bar bg-info" role="progressbar"
                                            aria-label="Segment one" style="width: 35%" aria-valuenow="35"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                        <div class="progress-bar bg-success" role="progressbar"
                                            aria-label="Segment two" style="width: 40%" aria-valuenow="40"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>United States</td>
                                                    <td><span>22,120</span><span
                                                            class="ms-4 text-dark">34.54%</span></td>

                                                </tr>
                                                <tr>

                                                    <td>India</td>
                                                    <td><span>12,756</span><span
                                                            class="ms-4 text-dark">22.43%</span></td>

                                                </tr>
                                                <tr>

                                                    <td>United Kingdom</td>
                                                    <td><span>8,864</span><span
                                                            class="ms-4 text-dark">34.54%</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Mexico</td>
                                                    <td><span>3,214 </span><span
                                                            class="ms-4 text-dark">3.12%</span></td>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="#!" class="btn btn-outline-white btn-sm">Export <i
                                        data-feather="arrow-down" class="icon-xxs"></i></a>
                                    ...
                                    <table class="table mb-0 text-nowrap table-centered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>/ <a href="#!" class="text-inherit"><i
                                                            data-feather="external-link" class="icon-xs"></i></a>
                                                </td>
                                                <td class="text-end">
                                                    <div>
                                                        <div>5,056 <span class="text-success"><i
                                                                    data-feather="arrow-up"
                                                                    class="icon-xs"></i><span
                                                                    class="ms-1">1%</span></span></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>/landings/courses.html <a href="#!"
                                                        class="text-inherit"><i data-feather="external-link"
                                                            class="icon-xs"></i></a>
                                                </td>
                                                <td class="text-end">
                                                    <div>
                                                        <div>2,385 <span class="text-danger"><i
                                                ...
                                                <td class="ps-0">
                                                    <div class="progress rounded-0 " style="height: 8px;">
                                                        <div class="progress-bar" role="progressbar"
                                                            aria-label="Basic example" style="width: 80%"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div>
                                                        <div>634 <span class="text-danger"><i
                                                                    data-feather="arrow-down"
                                                                    class="icon-xs"></i><span
                                                                    class="ms-1">1%</span></span></div>
                                                ...
                                                <td class="ps-0">
                                                    <div class="progress rounded-0 " style="height: 8px;">
                                                        <div class="progress-bar" role="progressbar"
                                                            aria-label="Basic example" style="width: 55%"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div>
                                                        <div>650 <span class="text-success"><i
                                                                    data-feather="arrow-up"
                                                                    class="icon-xs"></i><span
                                                                    class="ms-1">9%</span></span></div>
                                                ...
                                                <td class="ps-0">
                                                    <div class="progress rounded-0 " style="height: 8px;">
                                                        <div class="progress-bar" role="progressbar"
                                                            aria-label="Basic example" style="width: 40%"
                                            ...
                                            <tr>
                                                ...
                                                <td>/checkout.html <a href="#!" class="text-inherit"><i
                                                            data-feather="external-link" class="icon-xs"></i></a>
                                                </td>
                                                <td class="text-end">
                                                    <div>
                                                        <div>243 <span class="text-danger"><i
                                                                    data-feather="arrow-down"
                                                                    class="icon-xs"></i><span
                                                                    class="ms-1">3%</span></span></div>
                                                ...
                                                <td class="ps-0">
                                                    <div class="progress rounded-0 " style="height: 8px;">
                                                        <div class="progress-bar" role="progressbar"
                                                            aria-label="Basic example" style="width: 28%"
                                            ...
                                            <tr>
                                                ...
                                                <td>/blog.html <a href="#!" class="text-inherit"><i
                                                            data-feather="external-link" class="icon-xs"></i></a>
                                                </td>
                                                <td class="text-end">
                                                    <div>
                                                        <div>209 <span class="text-danger"><i
                                                                    data-feather="arrow-down"
                                                                    class="icon-xs"></i><span
                                                                    class="ms-1">2%</span></span></div>
                                                ...
                                                <td class="ps-0">
                                                    <div class="progress rounded-0 " style="height: 8px;">
                                                        <div class="progress-bar" role="progressbar"
                                                            aria-label="Basic example" style="width: 18%"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="border-top-0 "> <img
                                                    src="admin/assets/images/svg/browser-svg/chrome.svg"
                                        ...
                                        <tr>
                                            <td> <img src="admin/assets/images/svg/browser-svg/firefox.svg"
                                                    alt="Image" class="me-2"><span>Mozilla
                                                    Firefox</span></td>
                                            <td class="text-end  ">14.43%</td>

                                        </tr>
                                        <tr>
                                            <td> <img src="admin/assets/images/svg/browser-svg/brave.svg"
                                                    alt="Image" class="me-2"><span>Brave</span></td>
                                            <td class="text-end  ">14.43%</td>

                                        </tr>
                                        <tr>
                                            <td> <img src="admin/assets/images/svg/browser-svg/safari.svg"
                                                    alt="Image" class="me-2"><span>Apple
                                                    Safari</span></td>
                                        ...
                                        <tr>
                                            <td> <img src="admin/assets/images/svg/browser-svg/ie.svg"
                                                    alt="Image" class="me-2"><span>Internet Export</span>
                                            </td>
                                            <td class="text-end  ">6.21%</td>

                                        </tr>
                                        <tr>
                                            <td> <img src="admin/assets/images/svg/browser-svg/opera.svg"
                                                    alt="Image" class="me-2"><span>Opera
                                                    Mini</span></td>
                                            <td class="text-end  ">8%</td>

                                        </tr>
                                        <tr>
                                            <td> <img src="admin/assets/images/svg/browser-svg/microsoft-edge.svg"
                                                    alt="Image" class="me-2"><span>Microsoft edge</span>
                                            </td>
