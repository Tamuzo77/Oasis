<x-admin.layout title="Catégories d'Actualité">
    <x-admin.header title="Catégories d'Actualité" />

    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="">Site</a></li>
            <li class="breadcrumb-item active" aria-current="page">Catégorie d'Actualité</li>
        </ol>
    </nav>
                    ...
                    <td class="text-end">
                        <div class="dropdown dropstart">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                <form action="{{route('admin.categoryNew-delete', \Illuminate\Support\Facades\Crypt::encrypt($category->slug)) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button class="dropdown-item d-flex align-items-center" type="submit">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 16px;">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <!-- form group -->
                                        <form action="{{ route('admin.categoryNew-store') }}" method="POST">
                                            @csrf
